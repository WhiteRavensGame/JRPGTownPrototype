...
One day, as the sun rises a woman with cropped-blonde hair comes to your village and requests an audience with you. They speak with fervor as they ask for your help with rebuilding their home which broke down. Additionally, they are in need of more clothes and food. Do you help?
...
~ Changemorale(5)
~ ChangeBuildingProduction(1, "SilkFarm")
...
~ Changemorale(10)
~ ChangeBuildingProduction(2, "SilkFarm")
...
~ Changefood(-5)
~ Changemorale(10)
~ ChangeBuildingProduction(3, "SilkFarm")
-> END