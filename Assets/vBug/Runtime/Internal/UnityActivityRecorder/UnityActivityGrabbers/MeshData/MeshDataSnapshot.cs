...
namespace Frankfort.VBug.Internal
{
    ...
    public class MeshDataSnapshot : BaseDisposable
    {
    ...
    public class SWorldObject : BaseDisposable {
    ...
    public class SSubMeshArray : BaseDisposable{
    ...
    public class SMesh : BaseDisposable{
        ...
        public class HeaderData : BaseDisposable {
        ...
        public SVector2Array uv3;
        public SVector2Array uv4;
    ...
    public class SBonesArray : BaseDisposable{
    ...
    public class SBoneWeightArray : BaseDisposable {
