...
namespace Frankfort.VBug.Internal
{
    ...
    public static class TextureHelper
    {
                ...
                case ScreenCaptureQuality.lzfRGBA32:
                    if (scaleDown == 1){
                        while (i < iMax){
                            ...
                            //result[i++] = c.r; result[i++] = c.g; result[i++] = c.b; result[i++] = (byte)(Mathf.Min(255, (int)c.a * 2));
                        }
                    } else {
                        while (i < iMax){
        ...
        public static Texture2D SetBytes(byte[] input, bool hasAlpha, bool linear)
        {
            ...
            Texture2D result = TexturePool.GetTexture2D(width, height, linear);
