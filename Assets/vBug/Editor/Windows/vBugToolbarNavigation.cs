...
#else
            string startPath = Frankfort.VBug.Internal.vBugEnvironment.GetSaveRootFolder();
#endif
            string path = EditorUtility.OpenFolderPanel("Select the vBug save-data root folder", startPath, null);
